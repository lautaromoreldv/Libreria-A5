<?php
    ...
    if($tipousuario == 2 || empty($tipousuario)){
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top">
            <div class="container barra">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        <?php
                            foreach($navbar_adm as $item => $datos):
                                if(!$datos["visible"])
                                    continue;
                        ?>
    ...
    <main>
        <?php
            if(!empty($_GET["estado"])){
                ...
                if(!empty($_GET["mensaje"])){
                    ...
                    if(isset($errores_adm[$seccion]) && array_key_exists($mensaje, $errores_adm[$seccion])):
        ?>
        ...
        <?php
            if(!empty($_GET["seccion"])){
                ...
                if(array_key_exists($seccion, $navbar_adm)){
